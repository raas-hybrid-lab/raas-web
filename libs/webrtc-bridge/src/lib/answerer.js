    ...
    init = async () => {
        ...
        this._addIceCandidate = async (candidate, remoteClientId) => {
            ...
            if (this._inboundIceCandidateFilterFn(candidate)) {
                ...
                console.debug(this._loggingPrefix, `Candidate rejected through filter. Not adding candidate from ${remoteClientId || 'remote'}.`);
            }
        };
        ...
        this._peerConnection.addEventListener('track', event => {
            console.debug(this._loggingPrefix, 'Received track from', this._remoteClientId || 'remote', 'with track id:', event?.streams[0]?.id ?? '[Error retrieving track ID]');
        ...
        console.debug(this._loggingPrefix, 'Creating SDP answer for', this._remoteClientId || 'remote');
        ...
        console.debug(this._loggingPrefix, 'Generating ICE candidates for', this._remoteClientId || 'remote');
    };
